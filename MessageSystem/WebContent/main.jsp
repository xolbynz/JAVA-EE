<%@page import="com.messeage.MessageDAO"%>
<%@page import="com.messeage.MessageDTO"%>
							...
							<section id="two">
								<div class="inner">
									...
									<ul class="actions">
										...
										<%
										out.print("<table>");
										out.print("<tr>"+"<td>"+"<b>"+"메일"+"</b>"+"</td>");
										out.print("<td>"+"<b>"+"보낸사람"+"</b>"+"</td>");
										out.print("<td>"+"<b>"+"내용"+"</b>"+"</td>");
										out.print("<td>"+"<b>"+"날짜"+"</b>"+"</td>");
										out.print("<td>"+"<b>"+"삭제"+"</b>"+"</td>");
										out.print("</tr>");
											...
											for(int i=0; i<list.size();i++){
												...
												out.print("<td>"+list.get(i).getSend_name()+"</td>");
												out.print("<td>"+list.get(i).getContent()+"</td>");
												out.print("<td>"+list.get(i).getDay()+"</td>");
												out.print("<td><a href='MessageDelete.do?num="+list.get(i).getNum()+"' class ='button next scrolly'>삭제하기</a></td>");
												out.print("</tr>");
												
											}
											out.print("</table>");
										%>
										<li><a href="MessageDeleteAll.do" class="button next scrolly">전체삭제하기</a></li>
										<%} %>
									</ul>
								</div>
							</section>
